...
export const DiscoverDestinations = () => {
  ...
  return (
    <section className="py-24 px-4 md:px-12 lg:px-24 max-w-7xl mx-auto w-full bg-background border-t border-text-tertiary/10">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        <div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold tracking-tight text-text-primary mb-2">
      ...
      <div className="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-4 md:grid md:grid-cols-4 md:gap-6 md:grid-rows-3 md:h-[600px] -mx-4 px-4 md:mx-0 md:px-0">
